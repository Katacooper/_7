...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("The string contains the phrase: " + name);
        System.out.println("The string contains the phrase: " + name.toUpperCase());
        System.out.println("The string contains the phrase: " + name.toLowerCase());
    }
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "Primitives = " + "10 " + "true"; // <--- Edit this line
    ...
    private static void exercise4() {
        ...
        System.out.println("The correct order of number is: " + earlyNumbers + " " + middleNumbers.trim() + " " + endNumbers); // <--- Write your code here
    }
